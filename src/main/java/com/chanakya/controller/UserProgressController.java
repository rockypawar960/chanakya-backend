...
//import com.chanakya.service.ProgressTrackerServiceImpl;
...
//
//        Long userId = authUtil.getCurrentUserId(); // abhi static rakh sakta hai
//
...
//    public ResponseEntity<ProgressDataDTO> getProgressTrack(@PathVariable Long userId) {
//        return ResponseEntity.ok(progressTrackerService.getProgressData(userId));
//    }
//
//}